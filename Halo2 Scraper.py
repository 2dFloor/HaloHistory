...
def Halo2():
	...
	def GetGameHistory():
		print("Beginning GetGameHistory")
		more_pages = True
		page = 1
		...
		while (more_pages): 
			request = requests.get("https://halo.bungie.net/stats/playerstatshalo2.aspx?player=" + name + "&ctl00_mainContent_bnetpgl_recentgamesChangePage=" + str(page))
	...
	def SortPlayer():
		...
		# Write to file 
		try:
			file = open(target_name + " Halo2.txt", "w")
			cntr = 0
